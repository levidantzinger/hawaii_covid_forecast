...
death = pd.read_csv('https://www.cdc.gov/coronavirus/2019-ncov/downloads/covid-data/2021-04-05-all-forecasted-deaths-model-data.csv')
death.rename(columns={'target_week_end_date': 'forecast_end_date'}, inplace=True)

cases = pd.read_csv('https://www.cdc.gov/coronavirus/2019-ncov/downloads/cases-updates/2021-04-05-all-forecasted-cases-model-data.csv')
